...
function Form() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://sheets.devcrackthecode.net/api/v1/db/data/v1/crack_sheets/EstudiantesIngresoBarranquilla/views/estudiantes_ingreso_barranquilla",
        formData,
        {
          headers: {
  ...
  const fuentes_informacion_educativa_laboralOptions = [
    ...
    {
      value: "Orientadores, trabajadores sociales y/o psicólogos.",
  ...
  const actividades_realizadas_ultimo_añoOptions = [
    ...
    {
      value:
        "Responder una prueba de intereses (profesionales, vocacionales u ocupacionales).",
      label:
